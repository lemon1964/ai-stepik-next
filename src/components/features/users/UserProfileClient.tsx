      ...
      {mode === "neira" ? (
        ...
        <>
          ...
          <div className="relative z-10 px-4 py-6 text-gray-200">
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-4">
              <Link
                href="https://stepik.org/a/250212/pay?promo=66d7dd90b0ec575b"
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-4">
              <Link
                href="https://stepik.org/a/250427/pay?promo=818fda6d9aeec84d"
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-4">
              <Link
                href="https://stepik.org/a/253246/pay?promo=f6f737e3a49b2fea"
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-4">
              <Link
                href="https://stepik.org/a/272213/pay?promo=eeded360ec56739b"
                onClick={() => handleOutboundClick("STEPIK_course_IV")}
                // onClick={() => audioService.fadeOutMusic(5000)}
                className="mt-4 px-6 py-3 bg-amber-500 text-black font-bold rounded-xl hover:bg-amber-400 transition shadow-xl"
                target="_blank"
              >
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-4">
              <Link
                href="https://stepik.org/a/275811/pay?promo=447735d24048483d"
                onClick={() => handleOutboundClick("STEPIK_course_V")}
                // onClick={() => audioService.fadeOutMusic(5000)}
                className="mt-4 px-6 py-3 bg-amber-500 text-black font-bold rounded-xl hover:bg-amber-400 transition shadow-xl"
                target="_blank"
              >
